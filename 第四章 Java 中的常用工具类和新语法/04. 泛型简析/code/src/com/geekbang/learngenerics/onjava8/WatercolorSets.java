package com.geekbang.learngenerics.onjava8;// generics/WatercolorSets.java
// (c)2021 MindView LLC: see Copyright.txt
// We make no guarantees that this code is fit for any purpose.
// Visit http://OnJava8.com for more book information.

import com.geekbang.learngenerics.onjava8.watercolors.Watercolors;

import java.util.*;

import static com.geekbang.learngenerics.onjava8.onjava.Sets.*;// 静态导入
import static com.geekbang.learngenerics.onjava8.watercolors.Watercolors.*; // 静态导入

public class WatercolorSets {
    public static void main(String[] args) {
        // 将 枚举实例 A to B 添加到 集合a中
